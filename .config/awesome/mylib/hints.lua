-- Stolen from https://github.com/zackpete/hints/raw/master/hints.lua
...
function init()
	...
	for i = 1, #charorder do
		...
		letterbox[char] = widget( { type = "textbox" } )
		letterbox[char].align = "center"
		letterbox[char].text = "<span font='40' color=\"" .. beautiful.fg_normal .. "\"" .. "> " .. char.upper(char) .. "</span>"
